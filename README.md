...
Documentation is available in a separate [vdt_docs](Elphel/vdt-docs) repository.
Here are some [screenshots](/Elphel/vdt-docs/blob/master/VDT-UserManualAddendum.pdf)
